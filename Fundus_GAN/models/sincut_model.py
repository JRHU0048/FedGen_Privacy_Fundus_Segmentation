...
class SinCUTModel(CUTModel):  # The class that inherits from CUTModel implements the single image translation model
    ...
    def modify_commandline_options(parser, is_train=True):
        parser = CUTModel.modify_commandline_options(parser, is_train)  # Inherit the command-line execution of the parent class
        ...
        if is_train:   # Add instructions under the training model
    ...
    def __init__(self, opt):
        super().__init__(opt)  # Initialization method - Call the parent class
        if self.isTrain:
